        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" class="row g-3" method="POST" action="{{route('store.service')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" placeholder="Service Short Description" name="service_short"></textarea>
                            </div>
                            <div class="col-md-12">
