        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{route('store.slider')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" placeholder="Slider description" name="description"></textarea>
                            </div>
                            <div class="col-md-6">
