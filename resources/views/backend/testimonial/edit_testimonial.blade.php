        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="myForm" class="row g-3" method="POST" action="{{route('update.testimonial')}}">
                            @csrf
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" name="position" value={{$testi->position}}>
                            </div>
                            <div class="col-md-12 form-group">
                                <label for="validationDefault01" class="form-label">Message</label>
                                <textarea class="form-control" placeholder="Message" name="message">{{$testi->message}}</textarea>
                            </div>
