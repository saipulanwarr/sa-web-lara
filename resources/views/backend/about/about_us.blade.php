        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{route('update.aboutus')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="setup_growth" value="{{$about->setup_growth}}">
                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Problem Solving</label>
                                <input type="text" class="form-control" name="problem_solving" value="{{$about->problem_solving}}">
                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Passive Income</label>
                                <input type="text" class="form-control" name="passive_income" value="{{$about->passive_income}}">
                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Goal Achiever</label>
                                <input type="text" class="form-control" name="goal_achiever" value="{{$about->goal_achiever}}">
                            </div>
                            <div class="col-md-12">
                                <label for="validationDefault01" class="form-label">Description</label>
                                <textarea class="form-control" placeholder="Description" name="description">{{$about->description}}</textarea>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <img id="showImage" src="{{ asset('upload/about/'.$about->image)}}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
                            </div>
